...
union 
(select "2425_Matheson", a.sn, i.chan, a.realreaddate, i.utility, i.descpt, a.tch1 * i.mtpr, i.unit 
...
union 
(select "2425_Matheson", a.sn, i.chan, a.realreaddate, i.utility, i.descpt, a.tch2 * i.mtpr, i.unit 
...
group by a.sn, a.readdate order by a.sn, a.readdate asc) 
union 
(select "2425_Matheson", a.sn, i.chan, a.realreaddate, i.utility, i.descpt, a.tch3 * i.mtpr, i.unit 
...
group by a.sn, a.readdate order by a.sn, a.readdate asc) 
union 
(select "2425_Matheson", a.sn, i.chan, a.realreaddate, i.utility, i.descpt, a.tch4 * i.mtpr, i.unit 
...
group by a.sn, a.readdate order by a.sn, a.readdate asc) 
union 
(select "2425_Matheson", a.sn, i.chan, a.realreaddate, i.utility, i.descpt, a.tch5 * i.mtpr, i.unit 
...
group by a.sn, a.readdate order by a.sn, a.readdate asc) 
union 
(select "2425_Matheson", a.sn, i.chan, a.realreaddate, i.utility, i.descpt, a.tch6 * i.mtpr, i.unit 
...
group by a.sn, a.readdate order by a.sn, a.readdate asc) 
union 
(select "2425_Matheson", a.sn, i.chan, a.realreaddate, i.utility, i.descpt, a.tch7 * i.mtpr, i.unit 
...
group by a.sn, a.readdate order by a.sn, a.readdate asc) 
union 
(select "2425_Matheson", a.sn, i.chan, a.realreaddate, i.utility, i.descpt, a.tch8 * i.mtpr, i.unit 
...
INTO OUTFILE "C:/ptlspg/csv/2425_Matheson_Daily_2020-01-09.csv" FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\r\n';
